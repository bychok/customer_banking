...
def main():
    ...
    # The instructions don't mention using 'months' for calculations in the provided functions,
    # but we're collecting it in case it's needed for future enhancements.
